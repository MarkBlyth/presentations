...
\begin{frame}[label={sec:orgaa08836}]{Hyperparameters}
...
\begin{frame}[label={sec:org84f3eea}]{Characteristic lengths}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[plain,label={sec:orgfc01200}]{Characteristic lengths}
\begin{center}
\includegraphics[height=1.2\textheight]{./ls.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgabb781e}]{The effects of \(l\)}
\begin{columns}
...
\section{Next steps}
\label{sec:orgfbcaf8b}
\begin{frame}[label={sec:orga4fd8c5}]{Next steps}
\begin{itemize}
