...
\section{Background}
\label{sec:org70f79f9}
\begin{frame}[label={sec:org573ddc1}]{Week's goal}
Last week\ldots{}
\begin{itemize}
...
\begin{frame}[label={sec:org0ecc1ab}]{Week's activities}
\begin{itemize}
...
\begin{frame}[label={sec:orgac460c2}]{Presentation points}
\begin{enumerate}
...
\label{sec:orgab71a9f}
\begin{frame}[label={sec:orgfe49aa0}]{Why GPs?}
