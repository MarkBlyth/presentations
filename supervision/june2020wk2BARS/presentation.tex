...
\section{Background}
\label{sec:org09b02c2}
\begin{frame}[label={sec:org148630c}]{Week's goals}
\begin{itemize}
...
\label{sec:orgdc883d8}
\begin{frame}[plain,label={sec:orga006766}]{Bayesian free-knot splines}
...
\begin{frame}[label={sec:org4febaad}]{How it works}
\begin{enumerate}
...
\begin{frame}[label={sec:orge0d0daa}]{Spline bases}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgbc08767}]{Easy approach}
\begin{itemize}[<+->]
...
\section{Step 2}
\label{sec:org8524485}

\begin{frame}[label={sec:org8884c3a}]{Step 2: find a distribution over models}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgc112149}]{Bayesian approach}
\begin{itemize}
...
\begin{frame}[label={sec:orge60a3c9}]{Bayesian approach}
...
\begin{frame}[label={sec:orgbfe8838}]{MCMC sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org234cbb4}]{MCMC}
...
\begin{frame}[label={sec:org90a5207}]{Reversible-jump MCMC}
\begin{itemize}
...
\section{Step 3}
\label{sec:orgfe92276}
\begin{frame}[label={sec:orge098484}]{Model inference}
\begin{itemize}
...
\section{Results}
\label{sec:orgbc1a900}
\begin{frame}[label={sec:org4993623}]{My results}
\begin{itemize}
...
\begin{frame}[label={sec:org7bf3d4e}]{Results}
\begin{itemize}
...
\section{BARS GPR}
\label{sec:org7e62553}
\begin{frame}[label={sec:org52af2c7}]{BARS and GPR}
\begin{itemize}
...
\section{Next steps}
\label{sec:org47e5a8e}
\begin{frame}[label={sec:orgcdffe0f}]{Next steps}
\begin{enumerate}
\item Redraft paper
