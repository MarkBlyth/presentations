...
\section{Background}
\label{sec:org7ed8878}
\begin{frame}[label={sec:org610200e}]{Week's goals}
\begin{itemize}
...
\label{sec:orgacd3b41}
\begin{frame}[plain,label={sec:org4b59662}]{Bayesian free-knot splines}
...
\begin{frame}[label={sec:org4e21434}]{How it works}
\begin{enumerate}
...
\begin{frame}[label={sec:org36dfeb3}]{Spline bases}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org38692b6}]{Easy approach}
\begin{itemize}[<+->]
...
\section{Step 2}
\label{sec:org96f328e}

\begin{frame}[label={sec:orgf70b839}]{Step 2: find a distribution over models}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgd302925}]{Bayesian approach}
\begin{itemize}
...
\begin{frame}[label={sec:orga629a63}]{Bayesian approach}
...
\begin{frame}[label={sec:org54f15d1}]{MCMC sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org2923775}]{MCMC}
...
\begin{frame}[label={sec:orgf9ce58e}]{Reversible-jump MCMC}
\begin{itemize}
...
\section{Step 3}
\label{sec:orgfc289da}
\begin{frame}[label={sec:org51f447b}]{Model inference}
\begin{itemize}
...
\section{Results}
\label{sec:org1c588c1}
\begin{frame}[label={sec:org52f924e}]{My results}
\begin{itemize}
...
\begin{frame}[label={sec:orga7dee1a}]{Results}
\begin{itemize}
...
\section{BARS GPR}
\label{sec:orgdd7713d}
\begin{frame}[label={sec:orgfec0117}]{BARS and GPR}
\begin{itemize}
...
\section{Next steps}
\label{sec:orgbd6ff42}
\begin{frame}[label={sec:org6cc89a9}]{Next steps}
\begin{enumerate}
\item Redraft paper
