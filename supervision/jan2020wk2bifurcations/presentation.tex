...
\section{Background}
\label{sec:org23e4513}
\begin{frame}[label={sec:org4700b9b}]{Week's goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org24cf6e4}]{Week's activities}
\begin{itemize}
...
\section{Papers}
\label{sec:org026f35b}
\begin{frame}[label={sec:org4cb6af2}]{Global study of a family of cubic Lienard equations}
\begin{itemize}
...
\begin{frame}[label={sec:orge33314a}]{Fast subsystem bifurcations in a slowly varying lienard sysetem exhibiting bursting}
\begin{itemize}
\item Krassy's model uses a cubic Lienard equation as the fast subsystem
...
\label{sec:org2ad802c}
\begin{frame}[label={sec:org6c4a6a9}]{A first attempt at bifurcation diagrams}
\begin{itemize}
...
\begin{frame}[label={sec:orgb7857f6}]{The Hindmarsh-Rose model}
...
\begin{frame}[label={sec:org1643c88}]{HR Bifurcations}
\begin{itemize}
...
\begin{frame}[label={sec:org524e6d3}]{HR Bifurcations}
\begin{center}
...
\label{sec:org877d4f2}
\begin{frame}[label={sec:org727783a}]{Cubic Lienard system}
\begin{columns}
...
\begin{frame}[label={sec:orgf7812e1}]{Attempt 2}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\section{Next steps}
\label{sec:orgff38211}
\begin{frame}[label={sec:org943f7a4}]{Next steps}
\begin{itemize}
